  ...
  return (
    <>
      <button onClick={toggleCart} aria-label={`Cart (${count} items)`}
        style={{ position:'fixed', top:'20px', right:'20px', zIndex:200, background:orange, border:'none', borderRadius:'4px', padding:'10px 14px', cursor:'pointer', display:'flex', alignItems:'center', gap:'6px', color:'#fff', fontFamily:"'Bebas Neue', sans-serif", fontSize:'1rem', letterSpacing:'0.06em', transition:'all 0.25s ease' }}>
